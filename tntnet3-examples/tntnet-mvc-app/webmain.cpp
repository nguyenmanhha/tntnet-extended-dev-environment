...
#line 12 "session.ecpp"
  typedef Session session_type;
  TNT_SESSION_FILE_VAR(Session, session, session.ecpp, ());   // <%session> Session session
  _tnt_ignore_unused<session_type>(session);
#line 26 "session.ecpp"
  typedef Noty noty_type;
  TNT_REQUEST_FILE_VAR(Noty, noty, session.ecpp, ());   // <%request> Noty noty
...
std::string maincomp = request.getArg("next");
  ...
  // <%include> session.ecpp
#line 15 "session.ecpp"
