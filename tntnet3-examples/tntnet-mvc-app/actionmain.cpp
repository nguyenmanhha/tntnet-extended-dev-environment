...
log_define("component.actionmain")

// <%pre>
#line 1 "actionmain.ecpp"
...
static tnt::EcppComponentFactoryImpl<_component_> Factory("actionmain");
...
{
  log_trace("actionmain " << qparam.getUrl());
